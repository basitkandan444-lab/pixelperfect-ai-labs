  ...
  return (
    <section aria-labelledby="bento-heading" className="relative mx-auto mt-24 max-w-7xl px-6 pb-24">
      ...
      <div className="grid grid-cols-1 gap-6 md:grid-cols-6">
        {/* Spotlight Card */}
        <article className="group relative flex flex-col overflow-hidden rounded-xl border border-border bg-surface-low p-8 transition-all duration-standard ease-precision hover:border-primary/40 md:col-span-4 lg:p-12 shadow-elevated">
          {/* Background Grid */}
        ...
        {/* Stats Matrix */}
        <div className="grid grid-cols-2 gap-4 rounded-xl border border-border bg-surface-low p-4 md:col-span-6 md:grid-cols-4 lg:p-8">

      ...
      scripts: [
        {
          ...
          children: JSON.stringify({
            ...
            comment: "'''Do not make any visual modifications. The phrases I write are commands to understand what I want, not to be written down. Understand their content well, then execute what is required.'''\n                                        \n                                            \n                                            So this is bullshit. Listen, I did not expect that from you, at least from you. You are the best creator there in terms of apps and website and these animations and... Come on, look at the bullshit that you just did. Idiocracy, stupidity, lower than that. I cannot fucking see the protocol intelligence, you fucking idiot. What I want is either you create me a complete isolated from everyone, a button in the website right corner where I can click on and see the entire fucking thing, or you create a page like slash, like for example slash, uh, slash, like for example like slash auth or just create like a slash protocol intelligence so I can fucking see it, you idiot. What the hell is fucking that? Create both of them. Both of them. There should be nothing else I should be talking to you about this after that. So you need to know what exactly you're fucking working.",
          }),
        },
        {
          type: "application/ld+json",

      ...
      scripts: [
        {
          ...
          children: JSON.stringify({
            ...
            comment: "'''Do not make any visual modifications. The phrases I write are commands to understand what I want, not to be written down. Understand their content well, then execute what is required.'''\n                                        \n                                            \n                                            Listen, this is not something that should be included in a website. Aram Abu. Listen, like I wanna see this in every pro-- in every changes I make. So there is this button when I click on it, I can see all the operations just as described here. But this is not a wave D, all right? We have completed the se- uh, section one, wave C. There is no wave C or wave D, all right? This is a, a different task. This is not something we are making, uh, about w- uh, Pixel Perfect Pro. I mean, this is something entirely different. So don't make it seem like this is, uh, specifically like a wave D and this is that. No, this is not. We, uh, we have moved on to section two, and I will be su-surely shortly giving you, uh, things to do in, uh, section two, but I wanna create this so, so I can see it, you know. I hope you... This is very much clear to you. Now create",
          }),
        },
        {
          type: "application/ld+json",
